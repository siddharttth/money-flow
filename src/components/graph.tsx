...
import { useGrowClass, useTween } from './motion';
...
export function CategoryBubbles({
  ...
  const { boxProps, bubbleProps } = useBubblePhysics(bubbles, layoutKey);
  ...
  return (
    <div {...boxProps} className="relative w-full select-none" style={{ height: size }}>
      {bubbles.map((d, i) => {
